$(document).ready(function () {
    ...
    $("#rsvp-form").on("submit", function (e) {
        ...
        var expiredInviteCodes = [
            "d68e84140e6956552ce2dd8edc2dd627", // 911911
        ];
        if (!validInviteCodes.includes(MD5($("#invite_code").val()))) {

            if (!expiredInviteCodes.includes(MD5($("#invite_code").val()))) {
                $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrect."))
            } else {
                $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code has now expired."))

            $.post("https://script.google.com/macros/s/AKfycbx1yOKWfzMhIeUQUUD8Sg0-fIeeIWFHPC6-AnyW7jn9D8UGeZCAw92-H10ndpv9vhdA/exec", data).done(function(data) {
