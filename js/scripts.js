$(document).ready(function () {
    ...
    $("#rsvp-form").on("submit", function (e) {
        ...
        if (!validInviteCodes.includes(MD5($("#invite_code").val()))) {
            ...
            $.post("https://script.google.com/macros/s/AKfycbzHv6LVkXSwazcqqDS0AQI8jr9L9DJMf9LZnGhEPr6pzEiGMcaBSI9SPVnsNgoeJiHC/exec", data)
                .done(function (data) {
...
function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById("map-canvas"), { zoom: 15, center: location, scrollwheel: !1 });
    var marker = new google.maps.Marker({ position: location, map: map });
}
function initBBSRMap() {
    var la_fiesta = { lat: 45.41622699277486, lng: -74.0119070888575 };
    var map = new google.maps.Map(document.getElementById("map-canvas"), { zoom: 15, center: la_fiesta, scrollwheel: !1 });
    var marker = new google.maps.Marker({ position: la_fiesta, map: map });
}
